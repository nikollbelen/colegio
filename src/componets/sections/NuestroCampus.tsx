              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center space-x-2 px-6 py-3 rounded-full text-white font-semibold text-sm transition-all duration-300 transform hover:scale-105 shadow-lg ${
